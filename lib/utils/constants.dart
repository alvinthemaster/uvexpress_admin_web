...
class AppConstants {
  ...
  // Number Formats
  static final NumberFormat currencyFormat = NumberFormat.currency(symbol: '₱', decimalDigits: 2);
...
class AppStrings {
  ...
  static const String unsavedChanges = 'You have unsaved changes. Do you want to save before leaving?';
